...
def run_promotion_evaluator():
    ...
    label_encoder_department = load_pickle('1_label_encoder_department.pkl')
    label_encoder_region = load_pickle('1_label_encoder_region.pkl')
    label_encoder_education = load_pickle('1_label_encoder_education.pkl')
    label_encoder_gender = load_pickle('1_label_encoder_gender.pkl')
    label_encoder_recruitment_channel = load_pickle('1_label_encoder_recruitment_channel.pkl')
